...
bid=Entry(mid_frame,font="Ariel 12 bold ")
bid.grid(row=2, column=5)
...
def qx(query):
    ...
    return True
#--------------------------------------
Button(mid_frame,text="Add Bus",font="Ariel 12 bold ",bg='light green',activebackground="light green",command=lambda:rec(1)).grid(row=3,column=9,pady=30)
Button(mid_frame,text="Edit Bus",font="Ariel 12 bold ",bg='light green',activebackground="light green",command=lambda:rec(2)).grid(row=3,column=10,pady=30)
def home():
    root.destroy()
    import bbs_gui2
