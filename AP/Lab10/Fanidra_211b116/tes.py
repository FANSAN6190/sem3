...
#cur.execute('create table buses(bid varchar(5) PRIMARY KEY, oid int NOT NULL rid int FOREIGN KEY(rid) refrences route(rid),bus_type varchar(15), capacity int, fare int FOREIGN KEY(oid) refrences operator(oid)) ')
