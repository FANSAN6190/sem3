...
Button(mid_frame,text="Add Route",font="Ariel 12 bold ",bg='light green',activebackground="light green",command=conf).grid(row=2,column=9,padx=20)
Button(mid_frame,text="Delete Route",font="Ariel 12 bold ",bg='light green',fg="red",activebackground="light green").grid(row=2,column=10,padx=20)
