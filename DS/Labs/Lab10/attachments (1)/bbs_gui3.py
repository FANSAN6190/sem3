...
#---------------Frames-----------------
top_frame=Frame(root,bg="green yellow")
top_frame.grid(row=0,column=2,padx=w//5)

mid_frame=Frame(root,bg="turquoise1")
mid_frame.grid(row=2,column=2,padx=w//5,pady=20)

select_bus=Frame(root,bg="MediumPurple1")
select_bus.grid(row=5,column=2,pady=20)

booking=Frame(root,bg="MediumPurple2")
...
#-----------Mid Frame-----------------
Label(mid_frame,text="Enter Journey Details",font="Ariel 14 bold ",bg='light green',fg='green',relief="raised").grid(row=2,column=0,columnspan=15,pady=10)
...
Button(mid_frame,text="Show Bus",font="Ariel 12 bold ",bg='SpringGreen3',activebackground="SpringGreen3").grid(row=3,column=10,padx=10)
Button(mid_frame,image=img2).grid(row=3,column=11,padx=10)
#--------------------------------------
...
#Button(select_bus,text="Proceed to Book",font="Ariel 12 bold ",bg='lime green',activebackground="lime green").grid(row=6,column=10,padx=60)
#--------------------------------------

#--------------Booking-----------------
Label(booking,text="Fill Pasenger Details to book the bus ticket",font="Ariel 16 bold ",bg='light blue',fg='red',relief="raised").grid(row=0,column=0,columnspan=15,pady=30)
...
Button(booking,text="Book Seat",font="Ariel 12 bold ",bg='light green',activebackground="light green",command=conf).grid(row=2,column=14,padx=10)
#-------------------------------------
