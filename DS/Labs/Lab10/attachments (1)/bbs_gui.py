...
Label(mid_frame,text="Add Bus Details",font="Ariel 16 bold ",bg='light blue',fg='red',relief="raised").grid(row=0,column=0,columnspan=15,pady=30)
...
Label(mid_frame,text="Fare Rs",font="Ariel 12 bold ").grid(row=2, column=8)
jdate=Entry(mid_frame,font="Ariel 12 bold ")
jdate.grid(row=2, column=9)

Label(mid_frame,text="Operator ID",font="Ariel 12 bold ").grid(row=2, column=10)
mob=Entry(mid_frame,font="Ariel 12 bold ")
mob.grid(row=2, column=11)

Label(mid_frame,text="Route id",font="Ariel 12 bold ").grid(row=2, column=12)
age=Entry(mid_frame,font="Ariel 12 bold ")
age.grid(row=2, column=13)

def conf():
    a=showinfo("operator entry","operator record added.")
Button(mid_frame,text="Add Bus",font="Ariel 12 bold ",bg='light green',activebackground="light green",command=conf).grid(row=3,column=6)
Button(mid_frame,text="Edit Bus",font="Ariel 12 bold ",bg='light green',activebackground="light green").grid(row=3,column=7)
Button(mid_frame,image=img2).grid(row=3,column=8)
root.mainloop()